...
This chapter gives and discusses the preparatory work done for this project. We begin by explaining some key computer science concepts and algorithms used in this project, followed by a brief primer on some of the musical knowledge needed for this project. Next, we discuss and justify choices made for real-world data collection and metric calculation. We then discuss the requirements of this project, and finally talk about the software engineering tools and techniques that were employed throughout this project.
...
\subsection{Onset Detection}\label{subsec:onset detection}
 ...
 \begin{itemize}
   ...
   \item
     Take windows of the sound, we use a 32ms wide window and advance by 4ms and compute their DFT in the mel scale.
...
The temporal pattern in which notes are played between beats/bars is called the rhythm, but we do not make any attempt to infer rhythm.
