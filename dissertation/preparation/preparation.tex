...
This chapter gives and discusses the preparatory work done for this project. We begin by explaining some key concepts and algorithms used in this project. Next, we discuss and justify choices made for real-world data collection. We then discuss the requirements of this project, and finally talks about the software engineering tools and techniques that were employed throughout this project.
...
The data synthesis engine for piano data
